...
\begin{frame}[plain]
  ...
  \texttt{evnx 0.5.0} at commit \texttt{9cfe75b}.}
  \end{center}
\end{frame}
...
% ---------------------------------------------------------------------------
\input{commands/cmd-init}
\input{commands/cmd-add}
\input{commands/cmd-validate}
\input{commands/cmd-scan}
\input{commands/cmd-diff}
\input{commands/cmd-sync}
\input{commands/cmd-convert}
\input{commands/cmd-template}
\input{commands/cmd-migrate}
\input{commands/cmd-doctor}
\input{commands/cmd-spec}
\input{commands/cmd-backup-restore}
\input{commands/cmd-auth}
\input{commands/cmd-vault}
\input{commands/cmd-cloud}
\input{commands/cmd-completions}
